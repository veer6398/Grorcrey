...
const Navbar = ()=>{
        ...
        const {user,setUser,setShowUserLogin,navigate,searchQueary,setSearchQueary,cartCount,axios} = useAppContext();
        ...
        return (
            <nav className="flex items-center justify-between px-6 md:px-16 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
                ...
                <div className="hidden sm:flex items-center gap-8">
                    ...
                    <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                        <input onChange={(e)=> setSearchQueary(e.target.value)} className="py-1.5 w-full bg-transparent outline-none placeholder-gray-500" type="text" placeholder="Search products" />
